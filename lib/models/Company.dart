...
class Company extends Model {
  ...
  const Company._internal({required this.id, required name, required scale, last_login, createdAt, updatedAt}): _name = name, _scale = scale, _last_login = last_login, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Company({String? id, required String name, required String scale, TemporalTimestamp? last_login}) {
  ...
  Company copyWith({String? id, String? name, String? scale, TemporalTimestamp? last_login}) {
    return Company._internal(
      id: id ?? this.id,
      name: name ?? this.name,
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'name': _name, 'scale': _scale, 'last_login': _last_login?.toSeconds(), 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };

  static final QueryField ID = QueryField(fieldName: "company.id");
  static final QueryField NAME = QueryField(fieldName: "name");
  static final QueryField SCALE = QueryField(fieldName: "scale");
